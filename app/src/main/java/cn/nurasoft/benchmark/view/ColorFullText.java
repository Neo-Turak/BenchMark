package cn.nurasoft.benchmark.view;
...
public class ColorFullText extends androidx.appcompat.widget.AppCompatTextView {

    // some default params
    private static int DEFAULT_ABSOLUTE_TEXT_SIZE;
    private static final float DEFAULT_RELATIVE_TEXT_SIZE = 1;
     ...
     * @param context
     */
    public ColorFullText(Context context) {
        super(context);
        init();
    }

    public ColorFullText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ColorFullText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        ColorFullText.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }
    ...
    public static class Piece {
         ...
         * displayed. After doing so, you MUST call {@code display()} for the changes to show up.
         *
       Resources().getColor(R.color.colorId) for it)
         */
